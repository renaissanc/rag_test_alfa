        ...
        <div>
            ...
            <p>
             ...
             and attribute subsets X and Y, (X, Y  A), X ≠ 
                ...
                a
                b c
                IF NOT(Age  50) AND (Purchases more than equal to 3) THEN (Response = no) [b]
                IF (Age more than equal to 50) AND NOT (Purchases more than equal to 3) THEN (Response = yes) [c]
